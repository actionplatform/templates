...
```
src/main/java/{{cookiecutter.java_package_dir}}/
├── Application.java   Spring Boot entry point · Version.java
├── api/               HTTP only — controllers; PingController, v1/ItemsController
├── dto/               records that cross the HTTP boundary
